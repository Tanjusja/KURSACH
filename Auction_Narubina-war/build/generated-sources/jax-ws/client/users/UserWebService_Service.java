 ...
 * 
 */
@WebServiceClient(name = "UserWebService", targetNamespace = "http://users.ws/", wsdlLocation = "http://localhost:8080/UserWebService/UserWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICE_QNAME = new QName("http://users.ws/", "UserWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/UserWebService/UserWebService?wsdl");
    ...
    public UserWebService getUserWebServicePort() {
        return super.getPort(new QName("http://users.ws/", "UserWebServicePort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://users.ws/", "UserWebServicePort"), UserWebService.class, features);
    }
